...
const Hero = () => {
  return (
    <div className={'text-white mt-3 2xl:mt-10 w-full  py-5 mx-auto text-center flex flex-col justify-center '}>
      ...
      <button
        className={
          'text-xl text-black bg-white  rounded-2xl sm:text-2xl md:text-3xl xl:text-4xl   w-1/2 sm:w-56 mx-auto py-3 my-3  hover:border-gray-400 hover:bg-gray-300 hover:cursor-pointer  duration-500'
        }
      >
        Get started!
      </button>
